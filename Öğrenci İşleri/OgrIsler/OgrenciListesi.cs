...
namespace OgrIsler
{
    public partial class OgrenciListesi : Form
    {
        ...
        void OgrenimListe()
        {
            ...
            SqlCommand sorgu = new SqlCommand();
            sorgu.Connection = baglanti;
            sorgu.CommandText = "select * from ogr_ogrenim ";
            SqlDataAdapter adp = new SqlDataAdapter(sorgu);
            DataTable dt = new DataTable();
            adp.Fill(dt);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand sorgu = new SqlCommand();
            sorgu.Connection = baglanti;
            sorgu.CommandText = "select ogr_bilgi.ogrno,ogr_bilgi.adi+' '+ogr_bilgi.soyadi as'adisoyadi',ogr_bolum.badi,ogr_program.padi, ogr_okul.sinif, ogr_danisman.dadi, ogr_ogrenim.ogr_tur_adi from ogr_bilgi, ogr_okul,ogr_bolum, ogr_program, ogr_danisman,ogr_ogrenim where ogr_bilgi.ogrno=ogr_okul.ogrno and ogr_okul.pkodu=ogr_program.pkodu and ogr_program.bkodu=ogr_bolum.bkodu and ogr_okul.dkodu=ogr_danisman.dkodu and ogr_okul.ogr_tur=ogr_ogrenim.ogr_tur and ogr_okul.ogr_tur=@ogrenimturu";
            sorgu.Parameters.AddWithValue("@ogrenimturu", listBox1.SelectedValue);
            SqlDataAdapter adp = new SqlDataAdapter(sorgu);
            DataTable dt = new DataTable();
            adp.Fill(dt);
            dataGridView1.DataSource = dt;
